import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonCard, IonCardTitle, IonCardSubtitle, IonCardContent, IonCardHeader, useIonViewWillEnter, IonText } from '@ionic/react';
import './Tab3.css';
